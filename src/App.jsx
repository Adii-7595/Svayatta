    ...
    <div className="App">
      <div className="sideBar">
        <div className="upperside">
          <div className="upperSideTop"><img src={gptLogo} alt="Logo" className='logo' /><span className='brand'>Svayatta GPT</span></div>
          <button className='midBtn'><img src={addBtn} alt='New Chat' className='add' />New Chat</button>
        ...
        <div className="lowerSide">
          ...
          <div className="listItems"><img src={rocket} alt='' className='listItemImg' /> Upgrad to Pro </div>
